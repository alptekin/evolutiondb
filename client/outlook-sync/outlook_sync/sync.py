...
# Fields scanned for PII before storage. Anything not on this list
# (message IDs, folder names, flags, timestamps) is structural and
# safe to keep plaintext.
_PII_FIELDS = ["fact", "subject", "from", "to", "cc", "snippet", "body"]
