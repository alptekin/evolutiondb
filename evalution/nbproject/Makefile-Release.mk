...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Release.mk dist/Release/GNU-Linux-x86/deneme

dist/Release/GNU-Linux-x86/deneme: ${OBJECTFILES}
...
${OBJECTDIR}/evoparser.tab.o: nbproject/Makefile-${CND_CONF}.mk evoparser.tab.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/evoparser.tab.o evoparser.tab.c
...
${OBJECTDIR}/Update.o: nbproject/Makefile-${CND_CONF}.mk Update.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Update.o Update.c

${OBJECTDIR}/daemon_err.o: nbproject/Makefile-${CND_CONF}.mk daemon_err.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/daemon_err.o daemon_err.c
...
${OBJECTDIR}/Select.o: nbproject/Makefile-${CND_CONF}.mk Select.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Select.o Select.c
...
.clean-conf:
	${RM} -r build/Release
	${RM} dist/Release/GNU-Linux-x86/deneme
