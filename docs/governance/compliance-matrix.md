...
| Key rotation | Rotating the data-encryption key / re-keying the database. | — | **Roadmap** — not shipped | ISO A.8.24 (planned control) |
...
- **Key rotation / re-keying** for the at-rest encryption key — no rotation
